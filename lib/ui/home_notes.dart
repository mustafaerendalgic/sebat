        ...
        decoration: BoxDecoration(gradient: style.backgroundGradient),
          child: NotificationListener<OverscrollNotification>(
            onNotification: (notification) {
              if(notification is OverscrollNotification && notification.overscroll < 0 && notification.dragDetails != null){
                  ...
                  slivers: [
                            ...
                            builder: (builder, context){
                              ...
                              children: [
                                ...
                                ...NoteSortChip.values.map((filter){
                                  final bool isSelected = filter == noteSession.currentFilter;
                                  final Color color = isSelected ? Colors.white : style.gray;
                                  return ChoiceChip(
                                    selected: isSelected,
                                    ...
                                    style: TextStyles.bodyTextStyle.copyWith(color: color),),
                                    onSelected: (value) {
                                      if(value){
                    ...
                    SliverList(
                      delegate: SliverChildBuilderDelegate(
                        ...
                        if(index != 0 && noteHandler.notes[index - 1].date.split(" ")[1] != noteHandler.notes[index].date.split(" ")[1]){
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            spacing: 24,
                            children: [
                              Text(noteHandler.notes[index].date.split(" ").sublist(1).join(" "), style: TextStyles.titleTextStyle,),
                              NoteCards(note: item),
                            ],
                          );
                        }
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(
                    left: BorderSide(color: MainStyle.styleType.primary, width: 3)
                  ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Icon(CupertinoIcons.forward, color: MainStyle.styleType.black, size: 16,),
                      ],
                    ),
                  ],
                ),
